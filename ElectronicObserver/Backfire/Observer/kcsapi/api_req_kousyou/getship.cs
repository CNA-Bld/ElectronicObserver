...
namespace ElectronicObserver.Backfire.Observer.kcsapi.api_req_kousyou {
	...
	public class getship : APIBase {
		...
		public override void OnResponseReceived( dynamic data ) {
			...
			//api_ship
			{
				...
				ElectronicObserver.Utility.Logger.Add( 2, string.Format( "{0}「{1}」の建造が完了しました。", ship.MasterShip.ShipTypeName, ship.MasterShip.NameWithClass ) );
			}
